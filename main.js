...
function calcuate(arr){
  ...
  console.log(calcuate([22, -6, 32, 82, 9, 25]))
  ...
  console.log(sumArray(["1",4,3,"2"]))

//Arrays
//Your pokemon party order which is a list of pokemon has been leaked to Misty. Please create a function that reverses your list and prints it to the console. 

function reversePokemonList(list){
  console.log(list.reverse())
  }
  
  reversePokemonList(["pikachu","bulbasaur","snorlax"])
...
function evaluate(a,b){
  ...
  console.log(evaluate([1,2,20],[3,4,5]))
...
function pokemonLeague(numOfPokemons){
